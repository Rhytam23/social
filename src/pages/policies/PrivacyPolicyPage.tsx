    ...
    <main className="flex-1 w-full pb-16">
      <div className="container-max px-4 md:px-8 py-8">
        <nav className="flex items-center gap-2 text-xs font-mono text-[var(--text-secondary)] mb-6">
          ...
          <span className="text-[var(--accent-blue)]">PRIVACY POLICY</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 font-sans">
          <div className="lg:col-span-8 space-y-8 text-sm text-[var(--text-secondary)] leading-relaxed">
            <section className="space-y-3">
              <h2 className="text-[var(--text-primary)] font-bold text-xl tracking-tight">1. Information Collection & Usage</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-[var(--text-primary)] font-bold text-xl tracking-tight">2. Payment Gateway Encryption</h2>
              <p>
          ...
          <aside className="lg:col-span-4">
            <div className="bg-[var(--bg-surface)] border border-[var(--border-theme)] rounded-xl p-6 space-y-4 sticky top-24">
              <h3 className="text-[var(--text-primary)] font-bold text-base flex items-center gap-2">
                <Icon name="shield" size={18} className="text-[var(--accent-blue)]" />
                Data Privacy Officer
              </h3>
              <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
                Inquiries regarding data retention or account deletion requests.
              </p>
              <Link to="/support" className="text-[var(--accent-blue)] font-sans text-xs font-semibold hover:underline block pt-1">
