    ...
    <main className="flex-1 w-full pb-16">
      <div className="container-max px-4 md:px-8 py-8">
        <nav className="flex items-center gap-2 text-xs font-mono text-[var(--text-secondary)] mb-6">
          ...
          <span className="text-[var(--accent-blue)]">RETURN POLICY</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 font-sans">
          <div className="lg:col-span-8 space-y-8 text-sm text-[var(--text-secondary)] leading-relaxed">
            <section className="space-y-3">
              <h2 className="text-[var(--text-primary)] font-bold text-xl tracking-tight">30-Day Return Window</h2>
              <p>
              ...
              <div className="p-4 bg-[var(--bg-surface-secondary)] border border-[var(--border-theme)] rounded-xl text-xs font-mono space-y-1 text-[var(--text-secondary)]">
                <div><span className="text-[var(--text-primary)] font-semibold">Standard Return Period:</span> 30 Days from Delivery Scan</div>
                <div><span className="text-[var(--text-primary)] font-semibold">Restocking Fee:</span> 0% for unopened retail boxes</div>
                <div><span className="text-[var(--text-primary)] font-semibold">RMA Ticket SLA:</span> Initial response within 4 hours</div>
              </div>
            </section>
          </div>
          ...
          <aside className="lg:col-span-4">
            <div className="bg-[var(--bg-surface)] border border-[var(--border-theme)] rounded-xl p-6 space-y-4 sticky top-24">
              <h3 className="text-[var(--text-primary)] font-bold text-base flex items-center gap-2">
                <Icon name="autorenew" size={18} className="text-[var(--accent-blue)]" />
