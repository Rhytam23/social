        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7">
            <div className="bg-[#1a1b1f] border border-[#414755] rounded p-5">
              ...
              {/* Nav buttons */}
              <div className="flex items-center justify-between mt-6 pt-4 border-t border-[#292a2e] font-sans">
                <button
                  onClick={stepIndex === 0 ? () => navigate('/cart') : back}
                  className="px-4 py-2.5 border border-[#414755] hover:border-white text-white text-xs font-semibold rounded-xl transition-colors flex items-center gap-1.5"
                >
                  <Icon name="arrow_back" size={15} /> {stepIndex === 0 ? 'Back to Cart' : 'Back'}
                </button>
                {step !== 'Review' ? (
                  <button onClick={next} className="px-5 py-2.5 bg-[#007aff] hover:bg-[#0066d6] text-white text-xs font-bold rounded-xl flex items-center gap-1.5 transition-all shadow-sm">
                    Continue <Icon name="arrow_forward" size={15} />
                  </button>
                ) : (
                  <button onClick={placeFinalOrder} className="px-6 py-3 bg-[#30d158] hover:bg-[#28b84c] text-[#0d0e12] text-xs font-bold rounded-xl flex items-center gap-1.5 transition-all shadow-sm">
