...
- **Tests.** 253 tests (was 111). New: the real migrations run on an in-process Postgres and attacked as several users (`tests/security/rls.test.ts`), API route security tests, device linking, flood limits, theme default.
