...
- [ ] All migrations `001` to `022` applied in order (run the check queries in [Setup](SETUP.md#3-run-the-database-migrations)); `017` and `018` carry security fixes, `019` powers the admin error log
