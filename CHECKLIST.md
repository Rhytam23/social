...
- [ ] Hosting (`[P] PRODUCTION REQUIRED` — Vercel / Netlify deployment)
- [ ] Domain (`[P] PRODUCTION REQUIRED` — Custom domain DNS mapping)
- [ ] HTTPS (`[P] PRODUCTION REQUIRED` — SSL certificate active)
